...
export default function Page(){
    return <main className="min-h-screen bg-white pb-[60px] lg:pb-0 relative z-10">
                <div className={`${manrope.className} max-w-[1260px] mx-auto px-[15px] lg:px-[30px] pt-[10px] lg:pt-[20px] pb-[10px] lg:pb-[20px]`}>
                    <section className="mt-1 grid grid-cols-2 items-center gap-3">
                        <div className='z-10 space-y-8'>
                            ...
                            <div className="flex flex-col border-l-2 border-gray-200 space-y-3 px-3">
                        ...
                        <div>
                            <Image src={children} alt="" className='relative -left-35 min-w-4xl z-0'/>
                        </div>
                    </section>
                </div>
    </main>
